...
namespace ComponentEngine
{
	...
	public:
		...
		CCamera* GetMainCamera() const { return m_MainCamera; }
		void SetMainCamera(CCamera* cam) { m_MainCamera = cam; }

		AudioListener* GetAudioListener() const { return m_AudioListener; }
		void SetAudioListener(AudioListener* audioListener) { m_AudioListener = audioListener; }
